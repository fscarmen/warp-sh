...
```
  ...
  | ------------- | ------------- |
  | -h/--help     | Help |
  | -f/--file     | File to save account registration information, supporting official api, client, wgcf and warp-go. Also used as MASQUE config file. If not filled, manually enter device id and api token |
